...
int main() {
	...
	{
		auto *test = new BPsimulation::SocialNetwork<BPsimulation::implem::voter_stuborn>(20);
		...
		BPsimulation::implem::voter_majority_election<BPsimulation::implem::voter_stuborn> *election = new BPsimulation::implem::voter_majority_election<BPsimulation::implem::voter_stuborn>();
		...
		BPsimulation::implem::voter_stuborn_interaction_function *interaction = new BPsimulation::implem::voter_stuborn_interaction_function();
		for (int i = 0; i < 10; ++i) {
			if (i%1 == 0) {
				BPsimulation::implem::voter_majority_election_result *result = (BPsimulation::implem::voter_majority_election_result*)test->get_election_results(election);
				std::cout << "network->get_election_results(...) = " << result->result << " (" << int(result->proportion*100) << "%)\n";
	...
	{
		auto *test = new BPsimulation::SocialNetwork<BPsimulation::implem::AgentPopulationVoterStuborn>(800);
		...
		BPsimulation::core::agent::population::PopulationElection<BPsimulation::implem::voter_stuborn> *election            = new BPsimulation::core::agent::population::PopulationElection<BPsimulation::implem::voter_stuborn>(new BPsimulation::implem::voter_majority_election<BPsimulation::implem::voter_stuborn>());
		BPsimulation::core::agent::population::PopulationElection<BPsimulation::implem::voter_stuborn> *stuborness_election = new BPsimulation::core::agent::population::PopulationElection<BPsimulation::implem::voter_stuborn>(new BPsimulation::implem::voter_stuborness_election());
		...
		for (int i = 0; i < counties.size(); i++) {
			...
			BPsimulation::implem::voter_stuborness_result *county_stuborness = (BPsimulation::implem::voter_stuborness_result*)stuborness_results[i];
		...
		double dt = 0.2;
		BPsimulation::implem::population_voter_stuborn_interaction_function *interaction = new BPsimulation::implem::population_voter_stuborn_interaction_function(10);
		BPsimulation::implem::voter_stuborn_equilibirum_function            *agentwise   = new BPsimulation::implem::voter_stuborn_equilibirum_function(dt);
		BPsimulation::implem::voter_stuborn_overtoon_effect                 *overton     = new BPsimulation::implem::voter_stuborn_overtoon_effect(     dt, 0.015);
		BPsimulation::implem::voter_stuborn_frustration_effect              *frustration = new BPsimulation::implem::voter_stuborn_frustration_effect(  dt, 0.02);

		BPsimulation::core::agent::population::PopulationRenormalizeProportions<BPsimulation::implem::voter_stuborn> *renormalize = new BPsimulation::core::agent::population::PopulationRenormalizeProportions<BPsimulation::implem::voter_stuborn>();
	...
	{
		const int N_candidates = 3;
		auto *test = new BPsimulation::SocialNetwork<BPsimulation::implem::AgentPopulationNVoterStuborn<N_candidates>>(200);
		...
		BPsimulation::core::agent::population::PopulationElection<BPsimulation::implem::Nvoter_stuborn<N_candidates>> *election = new BPsimulation::core::agent::population::PopulationElection<BPsimulation::implem::Nvoter_stuborn<N_candidates>>(new BPsimulation::implem::Nvoter_majority_election<N_candidates, BPsimulation::implem::Nvoter_stuborn<N_candidates>>());
		...
		double dt = 0.2;
		BPsimulation::implem::population_Nvoter_stuborn_interaction_function<N_candidates> *interaction = new BPsimulation::implem::population_Nvoter_stuborn_interaction_function<N_candidates>(10);
		BPsimulation::implem::Nvoter_stuborn_equilibirum_function<N_candidates>            *agentwise   = new BPsimulation::implem::Nvoter_stuborn_equilibirum_function           <N_candidates>(dt);
		BPsimulation::implem::Nvoter_stuborn_overtoon_effect<N_candidates>                 *overton     = new BPsimulation::implem::Nvoter_stuborn_overtoon_effect                <N_candidates>(dt, 0.015);
		BPsimulation::implem::Nvoter_stuborn_frustration_effect<N_candidates>              *frustration = new BPsimulation::implem::Nvoter_stuborn_frustration_effect             <N_candidates>(dt, 0.02);

		BPsimulation::core::agent::population::PopulationRenormalizeProportions<BPsimulation::implem::Nvoter_stuborn<N_candidates>> *renormalize = new BPsimulation::core::agent::population::PopulationRenormalizeProportions<BPsimulation::implem::Nvoter_stuborn<N_candidates>>();
