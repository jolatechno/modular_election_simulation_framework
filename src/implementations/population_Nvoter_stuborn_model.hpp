...
namespace BPsimulation::implem {
	...
	class AgentPopulationNVoterStuborn : public core::agent::population::AgentPopulation<Nvoter_stuborn<N_candidates>> {
	public:
		...
		void randomize(const std::vector<double> &mean_equilibirum, const std::vector<double> &equilibrium_var, Args ...args) {
			...
			core::agent::population::AgentPopulation<Nvoter_stuborn<N_candidates>>::randomize(args...);
		}
		template<typename ...Args>
	...
	template<int N_candidates>
	class population_Nvoter_stuborn_interaction_function : public core::agent::AgentInteractionFunctionTemplate<core::agent::population::AgentPopulation<Nvoter_stuborn<N_candidates>>> {
	private:
	...
	public:
		...
		void operator()(core::agent::population::AgentPopulation<Nvoter_stuborn<N_candidates>> &agent,
			std::vector<const core::agent::population::AgentPopulation<Nvoter_stuborn<N_candidates>>*> neighbors) const
		{
	...
	template<int N_candidates>
	class Nvoter_stuborn_equilibirum_function : public core::agent::AgentWiseUpdateFunctionTemplate<AgentPopulationNVoterStuborn<N_candidates>> {
	public:
		double dt;
	...
	template<int N_candidates>
	class Nvoter_stuborn_overtoon_effect : public core::election::ElectionRetroinfluenceTemplate<AgentPopulationNVoterStuborn<N_candidates>> {
	private:
	...
	public:	
		...
		void operator()(AgentPopulationNVoterStuborn<N_candidates>& agent, const core::election::ElectionResultTemplate* election_result_) const {
	...
	template<int N_candidates>
	class Nvoter_stuborn_frustration_effect : public core::election::ElectionRetroinfluenceTemplate<AgentPopulationNVoterStuborn<N_candidates>> {
	public:
	...
	template<int N_candidates>
	class AgentPopulationNVoterStubornSerializer : public core::agent::AgentSerializerTemplate<AgentPopulationNVoterStuborn<N_candidates>> {
	private:
		core::agent::population::AgentPopulationSerializer<Nvoter_stuborn<N_candidates>> partial_serializer;
