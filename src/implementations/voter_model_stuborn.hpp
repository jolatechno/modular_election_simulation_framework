...
namespace BPsimulation::implem {
	...
	class voter_stuborn_interaction_function : public core::agent::AgentInteractionFunctionTemplate<voter_stuborn> {
	public:
	...
	class voter_stuborness_result : public core::election::ElectionResultTemplate {
	public:
	...
	class voter_stuborness_election : public core::election::ElectionTemplate<voter_stuborn> {
	public:
	...
	class VoterStubornSerializer : public core::agent::AgentSerializerTemplate<voter_stuborn> {
	public:
