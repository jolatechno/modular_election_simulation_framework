...
namespace BPsimulation::implem {
	...
	template<int N_candidates>
	class Nvoter_stuborn_interaction_function : public core::agent::AgentInteractionFunctionTemplate<Nvoter_stuborn<N_candidates>> {
	public:
	...
	template<int N_candidates>
	class NVoterStubornSerializer : public core::agent::AgentSerializerTemplate<Nvoter_stuborn<N_candidates>> {
	public:
