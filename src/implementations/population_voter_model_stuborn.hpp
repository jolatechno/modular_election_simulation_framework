...
namespace BPsimulation::implem {
	class AgentPopulationVoterStuborn : public core::agent::population::AgentPopulation<voter_stuborn> {
	public:
	...
	class population_voter_stuborn_interaction_function : public core::agent::AgentInteractionFunctionTemplate<core::agent::population::AgentPopulation<voter_stuborn>> {
	public:
		size_t N_select;
		population_voter_stuborn_interaction_function(size_t N_select_) : N_select(N_select_) {}

		void operator()(core::agent::population::AgentPopulation<voter_stuborn> &agent,
			std::vector<const core::agent::population::AgentPopulation<voter_stuborn>*> neighbors) const
		{
	...
	class voter_stuborn_equilibirum_function : public core::agent::AgentWiseUpdateFunctionTemplate<AgentPopulationVoterStuborn> {
	public:
		double dt;
	...
	class voter_stuborn_overtoon_effect : public core::election::ElectionRetroinfluenceTemplate<AgentPopulationVoterStuborn> {
	private:
	...
	public:
		...
		void operator()(AgentPopulationVoterStuborn& agent, const core::election::ElectionResultTemplate* election_result_) const {
	...
	class voter_stuborn_frustration_effect : public core::election::ElectionRetroinfluenceTemplate<AgentPopulationVoterStuborn> {
	public:
	...
	class AgentPopulationVoterStubornSerializer : public core::agent::AgentSerializerTemplate<AgentPopulationVoterStuborn> {
	private:
		core::agent::population::AgentPopulationSerializer<voter_stuborn> partial_serializer;
